          ...
          <div class="flex flex-wrap md:text-left text-center order-first">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <a class="hover:text-indigo-900">First Link</a>
                </li>
                <li>
                  <a class="hover:text-indigo-900">Second Link</a>
                </li>
                <li>
                  <a class="hover:text-indigo-900">Third Link</a>
                </li>
                <li>
                  <a class="hover:text-indigo-900">Fourth Link</a>
                </li>
              </nav>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
